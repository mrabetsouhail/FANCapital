...
public class LiquidityPoolWriteService {
  ...
  public LiquidityPoolWriteService(Web3j web3j, DeploymentRegistry registry, BlockchainProperties props) {
    this.web3j = web3j;
  ...
  public String buyFor(BuyRequest req) {
    ...
    return send(pool, fn, BigInteger.valueOf(1_000_000));
  }
  ...
  public String sellFor(SellRequest req) {
    ...
    return send(pool, fn, BigInteger.valueOf(1_200_000));
  }
